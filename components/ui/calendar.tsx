  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md xl:w-11 lg:w-9 w-7 font-normal text-lg",
        ...
        day: cn(
          ...
          "lg:text-xl xl:h-11 xl:w-11 lg:w-9 lg:h-9 w-7 h-7 p-0 font-normal aria-selected:opacity-100"
        ),
        day_selected:
